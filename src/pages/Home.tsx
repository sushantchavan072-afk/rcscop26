        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 sm:py-20 w-full">
          <div className="flex flex-col items-center text-center">
            ...
            <motion.h1
              ...
              animate="visible"
              custom={1}
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.1] text-white tracking-tight josefin-sans uppercase poppins capitalize"
            >
              Rotaract Club Of
              <span className="block text-primary mt-2 poppins">Sinhgad College Of Pharmacy</span>
            </motion.h1>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                We are a dynamic, youth-led club under Rotary International, empowering future professionals through meaningful community service, hands-on leadership, and strong professional development. Based at Sinhgad College of Pharmacy, we strive to create positive change in our community while building tomorrow's leaders.
              </p>
              <Link to="/about">
