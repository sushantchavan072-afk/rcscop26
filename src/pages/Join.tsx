    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Become part of a global movement of young leaders dedicated to creating positive change.
          </motion.p>
        </motion.div>
              ...
              <Card className="shadow-lg">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    ...
                    <p>• Willingness to participate in projects</p>
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="age" type="number" min="18" max="30" required />
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="collegeName">College Name *</Label>
                      <Input id="collegeName" placeholder="e.g., Sinhgad College of Pharmacy" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="branch">Branch *</Label>
                      <Input id="branch" placeholder="e.g., B.Pharm, D.Pharm" required />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" rows={4} placeholder="Tell us about your interest in Rotaract and what you hope to contribute..." required />
                  </div>
