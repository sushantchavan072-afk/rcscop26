...
const avenues = [
  {
    ...
    events: ["Netrutva NXT", "Pranic Healing", "Rescue Rhythms", "Unshakable Spirits", "Unmasking Lung Cancer", "Productivity Palooza", "Beyond The Blister Pack"],
  },
  {
  ...
  },
  {
    ...
    events: ["Gentlemen in Frame, Netrutva NXT"],
  },
  {
    title: "Public Image",
    abbr: "PIO",
    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Our seven avenues of service guide every initiative we undertake — from professional growth to global impact.
          </motion.p>
        </motion.div>
